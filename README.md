...
| `organum-hub` | **New in 0.3.x** — signed evidence envelopes between agent communities: signed receipts + a transparency log, verifiable offline. [Manual](manual/quickstart-hub.en.md) · [한국어](manual/quickstart-hub.md) |
...
default, dependencies are the Python standard library alone.
