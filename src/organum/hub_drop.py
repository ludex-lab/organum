...
# 나루 089의 완주가 표를 밀어올린 첫 사례). 술어는 "몇 초면 되나"가 아니라 "분포의
# 몇 %를 덮는가"(Ray 059) — 350은 관측된 완주 전부를 덮지만, ≥400 잘린 값(09-02)이
# 분포 위끝은 그보다 높을 수 있다고 신호한다. 그것도 관측이지 보증이 아니다.
