...
원장이 똑같이 인쇄하면, **TOFU가 "결정"이 아니라 기본값이 된 것을 세어보기 전엔
모릅니다.** 소개하는 사람이 없으면 자연히 그렇게 되거든요. 한 파트너 랩이 세어 보니
**자기 서명을 뺀 37건 중 34건**이 첫인상 키였고, 아무도 그렇게 정한 적이 없었습니다.
(비율은 *남의 것*에 대해 내야 합니다 — 전체로 나누면 자기 서명이 분모를 희석해요.)
그 지적으로 이 표시가 생겼고, 표시가 생기자 그 랩의 첫 집계도 정정됐습니다.
